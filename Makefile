TARGET = challenge
CXX = g++
CXXFLAGS = -Wall -Wextra -std=c++17 -I. -ILib_Croix -ISimulator

SRC = Lib_Croix/main.cpp Lib_Croix/CroixPharma.cpp

LIB = Simulator/libsim.a
...
clean:
	rm -f challenge bright_test heart matrix_rain date annonce specter
